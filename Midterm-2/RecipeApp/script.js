...
function returnToMenu() {
    document.getElementById('favorites-section').style.display = 'none'; // Hide favorites
    document.getElementById('recipes-section').style.display = 'block';  // Show main recipes
}
